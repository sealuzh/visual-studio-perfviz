...
{
    class InsightsExternalReferencesRestApiDataService : IDataService
    {
        ...
        public InsightsExternalReferencesRestApiDataService()
        {
        ...
        public async Task<IList<ConcreteMemberTelemetry>> GetNewTelemetriesTaskAsync()
        {
            ...
            var performanceInfoList = new List<ConcreteMemberTelemetry>();
